...
After this, I also to create the component's footprint, for eventually placing and routing the compoennt in the actual design of the PCB. This was also a simple process, using a variety of measurements from the datasheet in order for the pads to properly match the component when soldering later on. 
